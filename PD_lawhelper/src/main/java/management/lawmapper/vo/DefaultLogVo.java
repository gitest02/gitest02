...
public class DefaultLogVo {
	...
	private String search_logDate_fromdate;
	private String search_logDate_todate;
	/** 검색조건 */
  ...
  public void setPaging(){
	...
	public String getSearch_logDate_fromdate() {
		return search_logDate_fromdate;
	}

	public void setSearch_logDate_fromdate(String search_logDate_fromdate) {
		this.search_logDate_fromdate = search_logDate_fromdate;
	}

	public String getSearch_logDate_todate() {
		return search_logDate_todate;
	}

	public void setSearch_logDate_todate(String search_logDate_todate) {
		this.search_logDate_todate = search_logDate_todate;
	}

	@Override
	public String toString() {
		return "DefaultLogVo [search_userId=" + search_userId
				+ ", search_logType=" + search_logType
				+ ", search_logDate_fromdate=" + search_logDate_fromdate
				+ ", search_logDate_todate=" + search_logDate_todate
