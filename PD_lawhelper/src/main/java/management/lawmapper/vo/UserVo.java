...
//	StandardPasswordEncoder encoder = new StandardPasswordEncoder();
	...
	public String toString() {
		return "UserVo [userid=" + userid + ", name=" + name + ", password="
				+ password + ", grade=" + grade + ", address=" + address
				+ ", phone=" + phone + ", email=" + email + ", career="
				+ career + ", position=" + position + ", sex=" + sex
				+ ", birth=" + birth + ", engname=" + engname + ", gradeName="
				+ gradeName + ", sexName=" + sexName + "]";
	}
