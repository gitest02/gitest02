package lawsuit_rec.lawmapper.vo;

import com.nexacro.spring.data.DataSetRowTypeAccessor;

public class LawsuitRecVO implements DataSetRowTypeAccessor {
	...
	private String instAdmJudId; // 판사 ID
	private String instAdmJudName; // 판사 이름
