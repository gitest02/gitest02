(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"Column0\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"Column0\">xxxxxxx</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("Button02", "absolute", "36%", "182", null, "37", "32.75%", null, this);
            obj.set_taborder("4");
            obj.set_text("부모폼의 객체 접근\r\n(Div.Div)");
            this.addChild(obj.name, obj);

            obj = new Button("Button03", "absolute", "36%", "222", null, "37", "32.75%", null, this);
            obj.set_taborder("5");
            ...
            obj = new Button("Button07", "absolute", "3%", "262", null, "37", "66%", null, this);
            obj.set_taborder("10");
            obj.set_text("부모폼으로 값 전달");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit00", "absolute", "278", "16", "99", "34", null, null, this);
            obj.set_taborder("11");
            obj.set_value("팝업창입니다.");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("Form1_Pop.xfdl", function() {
        ...
        {
         	this.opener.Edit00.set_value("값 전달~");
         	this.opener.Dataset00.setColumn(0,"Column0", "값전달");
        	this.opener.fn_test1("값전달", this.Dataset00);
        	this.close("success");
        }
        ...
        this.loadIncludeScript("Form1_Pop.xfdl");
